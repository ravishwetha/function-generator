...
## Switches
set_property PACKAGE_PIN V17 [get_ports {MODE_RST_SW}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MODE_RST_SW}]
set_property PACKAGE_PIN V16 [get_ports {MAXMIN_AMP_SW}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MAXMIN_AMP_SW}]
